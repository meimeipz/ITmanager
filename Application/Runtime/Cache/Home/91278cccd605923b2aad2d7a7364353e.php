	...
	<table class="data-table" width="100%">
      ...
      <tbody>
        ...
        <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td><strong><a href="index.php?p=home&c=equipment&a=grantEquipment_update&zichanNum=<?php echo ($vo['zichannum']); ?>&description=<?php echo ($vo['description']); ?>">发放</a></strong></td>
