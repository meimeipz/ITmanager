...
<form class="form-signin"  method="get" action="index.php?p=home&c=user&a=register">
	...
	<input name="repassWord" id="repassWord" type="text" class="form-control" placeholder="密码确认" required>

	<br>

	<input name="email" id="email" type="mail" class="form-control" placeholder="邮箱" required>

	<br>

	<input name="level" id="level" type="text" class="form-control" placeholder="用户级别" required>

	<br>


	<input type="submit" class="btn btn-lg btn-primary btn-block"  value="注册"> 
	<a href="index.php?p=home&c=index&a=index"">用户登录</a>   
